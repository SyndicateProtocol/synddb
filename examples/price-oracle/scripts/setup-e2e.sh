...
echo ""
echo "To run the validator with price oracle invariants:"
echo "  source examples/price-oracle/.e2e-env"
echo "  cargo run -p synddb-bridge-validator -- \\"
echo "      --bridge-address \$BRIDGE_ADDRESS \\"
echo "      --bridge-chain-id 31337 \\"
echo "      --rpc-url \$RPC_URL \\"
echo "      --private-key \$VALIDATOR_PRIVATE_KEY \\"
echo "      --http-port 8080 \\"
echo "      --enable-price-oracle-invariants \\"
echo "      --price-divergence-max-bps 100"
echo ""
echo "To test the price oracle (without validator):"
echo "  source examples/price-oracle/.e2e-env"
echo "  cd examples/price-oracle"
echo "  source .venv/bin/activate"
echo "  pytest tests/test_e2e_bridge.py -v"
echo ""
echo "To test the full validator flow (requires running validator):"
echo "  source examples/price-oracle/.e2e-env"
echo "  cd examples/price-oracle"
echo "  source .venv/bin/activate"
echo "  pytest tests/test_validator_e2e.py -v -s"
echo ""
