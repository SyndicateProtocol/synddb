...
# Core: RUST_LOG, BIND_ADDRESS, DATABASE_PATH, STATE_DB_PATH, PENDING_CHANGESETS_DB_PATH, SEQUENCER_URL
...
# Logging: LOG_JSON
LABEL "tee.launch_policy.allow_env_override"="RUST_LOG,BIND_ADDRESS,DATABASE_PATH,STATE_DB_PATH,PENDING_CHANGESETS_DB_PATH,SEQUENCER_URL,GCS_BUCKET,GCS_PREFIX,FETCHER_TYPE,DA_PROVIDER,SYNC_INTERVAL,BATCH_SYNC_ENABLED,BRIDGE_SIGNER,BRIDGE_CONTRACT_ADDRESS,BRIDGE_CHAIN_ID,ENABLE_KEY_BOOTSTRAP,TEE_KEY_MANAGER_CONTRACT_ADDRESS,BOOTSTRAP_RPC_URL,BOOTSTRAP_CHAIN_ID,PROOF_SERVICE_URL,ATTESTATION_AUDIENCE,RELAYER_URL,IMAGE_SIGNATURE,LOG_JSON"
