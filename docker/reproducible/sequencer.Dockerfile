...
# Logging: LOG_JSON
LABEL "tee.launch_policy.allow_env_override"="RUST_LOG,BIND_ADDRESS,SIGNING_KEY,GCS_BUCKET,GCS_PREFIX,PUBLISHER_TYPE,BATCH_MAX_MESSAGES,BATCH_MAX_BYTES,BATCH_FLUSH_INTERVAL,BRIDGE_CONTRACT_ADDRESS,ENABLE_KEY_BOOTSTRAP,TEE_KEY_MANAGER_CONTRACT_ADDRESS,BOOTSTRAP_RPC_URL,BOOTSTRAP_CHAIN_ID,PROOF_SERVICE_URL,ATTESTATION_AUDIENCE,RELAYER_URL,LOG_JSON"
