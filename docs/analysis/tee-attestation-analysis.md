...
```rust
// crates/gcp-confidential-space/src/attestation.rs:166
...
```rust
// crates/gcp-confidential-space/src/attestation.rs:171-203
...
| GCP CS library | `crates/gcp-confidential-space/src/` |
