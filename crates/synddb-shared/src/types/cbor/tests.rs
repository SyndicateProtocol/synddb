...
mod integration_tests {
    use crate::types::cbor::batch::CborBatch;
    use crate::types::cbor::error::CborError;
    use crate::types::cbor::message::{CborMessageType, CborSignedMessage};
    ...
    fn signer_address(signer: &PrivateKeySigner) -> [u8; 20] {
    ...
    fn test_all_message_types() {
        ...
        for msg_type in [
            ...
            let msg =
                CborSignedMessage::new(1, 1700000000, msg_type, b"test".to_vec(), addr, |data| {
                    sign_sync(&signer, data)
                })
                .unwrap();
