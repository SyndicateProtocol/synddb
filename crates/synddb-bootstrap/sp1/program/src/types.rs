//! SP1 public values for on-chain verification
//!
//! This module contains the `PublicValuesStruct` that defines the interface between
//! the SP1 zkVM proof and the Solidity verifier contract. The struct is ABI-encoded
//! by the SP1 program and decoded on-chain.
