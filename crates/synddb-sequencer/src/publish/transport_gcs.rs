...
use crate::publish::transport::TransportError;
...
mod impl_gcs {
    use super::*;
    use crate::publish::transport::{BatchInfo, PublishMetadata, TransportPublisher};
...
#[derive(Debug)]
pub struct GcsTransport {
    _config: GcsTransportConfig,
}

#[cfg(not(feature = "gcs"))]
impl GcsTransport {
    pub async fn new(_config: GcsTransportConfig) -> Result<Self, TransportError> {
