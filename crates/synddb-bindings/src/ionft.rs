...
```*/
    ...
    ///Container for all the [`IONFT`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IONFTCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IONFTCalls {
        const NAME: &'static str = "IONFTCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IONFTCalls>] = &[
                {
                    fn crosschainMint(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IONFTCalls> {
                        <crosschainMintCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                            )
                            .map(IONFTCalls::crosschainMint)
                    }
                    crosschainMint
                },
                {
    ...
    /**Creates a new wrapper around an on-chain [`IONFT`](self) contract instance.

See the [wrapper's documentation](`IONFTInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(address: alloy_sol_types::private::Address, __provider: P) -> IONFTInstance<P, N> {
        IONFTInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IONFTInstance<P, N>>,
    > {
        IONFTInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IONFTInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IONFT`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IONFT`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IONFTInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IONFTInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IONFTInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IONFTInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IONFTInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IONFTInstance<P, N> {
            IONFTInstance {
